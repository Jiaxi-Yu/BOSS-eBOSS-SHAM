...
def prior(cube, ndim, nparams):
    ...
    cube[1] = 1000*cube[1]  # uniform between [0,1000]
...
fileroot = 'MCMCout/0518/'+gal+'_'+GC+'_'+var+'/'+gal+'_'+GC+'_'+var+'_'

# run MultiNest & write the parameter's name
pymultinest.run(loglike, prior, n_params,n_live_points= npoints, outputfiles_basename=fileroot, resume = True, verbose = True)
...
g.plot_2d(sample, 'sigma', 'vcut', filled=True)
g.export('{}_{}_bestfit_prior.pdf'.format(gal,GC))
'''
fin = time.time()  
