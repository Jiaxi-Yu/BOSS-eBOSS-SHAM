...
time_end=time.time()
print('parallel calculation best param sigma_high, sigma_low, v_max = {:.4},{:.4},{:.6} km/s \n'.format(sigma.values[0],sigma.values[2],sigma.values[1]))
f.write('chi-square fitting finished, costing {:.5} s \n'.format(time_end-time_start))
f.write('parallel calculation best param sigma_high, sigma_low, v_max = {:.3},{:.3},{:.6} km/s \n'.format(sigma.values[0],sigma.values[2],sigma.values[1]))
#
f.close()
