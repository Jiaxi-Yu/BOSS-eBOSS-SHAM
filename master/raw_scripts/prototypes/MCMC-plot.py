...
fileroot = 'MCMCout/'+date+'/'+func[id]+'_'+gal+'_'+GC+'/multinest_'
...
if multipole=='mono':
    ...
    plt.savefig(func[id]+'-MCMC_cf_mono_bestfit_'+gal+'_'+GC+'.png',bbox_tight=True)
    plt.close()
if multipole=='quad':
    ...
    plt.savefig(func[id]+'-MCMC_cf_quad_bestfit_'+gal+'_'+GC+'.png',bbox_tight=True)
    plt.close()
if multipole == 'hexa':
    ...
    plt.savefig(func[id]+'-MCMC_cf_hexa_bestfit_'+gal+'_'+GC+'.png',bbox_tight=True)
    plt.close()
...
for uniform in uniform_randoms:
    ...
    ax.plot(bins[:-1],n2/(n+1),alpha=0.5,lw=0.5)
...
plt.savefig(func[id]+'-MCMC_distr_'+gal+'_'+GC+'.png',bbox_tight=True)
plt.close()
