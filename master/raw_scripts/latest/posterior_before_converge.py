...
prefix = 'MCMCout/0605/LRG_NGC_Vsmearfix/multinest_'
...
for yi in range(2): 
    for xi in range(yi):
        ax = axes[yi, xi]
        ax.axvline(a.get_best_fit()['parameters'][0], color="g")
        ax.axhline(a.get_best_fit()['parameters'][1], color="g")
        ax.plot(a.get_best_fit()['parameters'][0],a.get_best_fit()['parameters'][1], "sg") 
plt.savefig('posterior_Vsmearfix.png')
print('the best-fit parameters: sigma {:.4}, Vceil {:.6}'.format(a.get_best_fit()['parameters'][0],a.get_best_fit()['parameters'][1]))
