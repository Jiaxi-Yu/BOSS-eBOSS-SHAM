...
files = glob('/global/cscratch1/sd/jiaxi/master/catalog/nersc_zbins_wp_mps_'+gal+'/EZmocks/z'+zmin+'z'+zmax+'/2PCF/2PCF_EZmock_eBOSS_'+gal+'_NGC_v7_z'+zmin+'z'+zmax+'_*.dd') 

s =ascii.read('/global/cscratch1/sd/jiaxi/master/binfile_log.dat',format = 'no_header')['col3']
...
mps_log_{}_NGC+SGC_eBOSS_{}_zs_{}0-{}0.dat'.format(gal,gal,ver,zmin,zmax),format = 'no_header')
    
else:
    obs =ascii.read('/global/cscratch1/sd/jiaxi/master/catalog/nersc_zbins_wp_mps_{}/\
mps_log_{}_NGC+SGC_eBOSS_{}_zs_{}-{}0.dat'.format(gal,gal,ver,zmin,zmax),format = 'no_header')
    
if (gal=='ELG')&(sys.argv[6]=='1'):
        # compare ELG obs with pair counts from Faizan
    pairs = ascii.read('/global/cscratch1/sd/jiaxi/master/catalog/PIP+ANG_pair_counts/pairs_s-mu_log_eBOSS_ELG_NGC+SGC_v7_pip_zs_{}0-{}0.dat'.format(zmin,zmax))
