...
def get_delta_velocities_from_repeats(spall, spec1d=0, redrock=0, redmonster=0):
...
def plot_deltav_deltachi2(info, title=None, save=0):
...
def plot_all_deltav_deltachi2(spall):
    ...
    for target in ['LRG']:
        ...
        #-- Redrock
        info1 = get_delta_velocities_from_repeats(sp, redrock=1)
        
        plot_deltav_deltachi2(info1, title=f'eBOSS {target} repeats - redrock', 
                   save=f'plots/eboss-{target}-repeats-redrock-no_andmask.pdf')

def plot_all_deltav_histograms(spall):

    spall = Table.read(spall)

    for target in ['LRG']:
        sp = get_targets(spall, target=target)
        info = get_delta_velocities_from_repeats(sp, redrock=1)
        plot_deltav_hist(info, title=f'eBOSS {target} -', 
                   save=f'plots/eboss-{target}-repeats-redrock-no_andmask-histogram.pdf')
...
#write_spall_repeats('data/spAll-zbest-v5_13_0.fits', 'data/spAll-zbest-v5_13_0-repeats-2x.fits')
#plot_all_deltav_deltachi2('data/spAll-zbest-v5_13_0-repeats-2x.fits')

#write_spall_redrock_join('data/spAll-zbest-v5_13_0-repeats-2x.fits', 
...
#                         'data/spAll-zbest-v5_13_0_no_andmask-repeats-2x-eBOSS.fits')
plot_all_deltav_deltachi2('data/spAll-zbest-v5_13_0_no_andmask-repeats-2x-eBOSS.fits')
plot_all_deltav_histograms('data/spAll-zbest-v5_13_0_no_andmask-repeats-2x-eBOSS.fits')
plt.show()
#get_false_positives('data/spAll-zbest-v5_13_0_no_andmask-skies.fits', spec1d=1)
#get_false_positives('data/spAll-zbest-v5_13_0_no_andmask-skies.fits', redrock=1)
