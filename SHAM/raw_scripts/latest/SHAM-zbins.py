...
fileroot = '{}MCMCout/3-param_{}/{}_{}_{}_{}_z{}z{}/multinest_'.format(direc,date,function,rscale,gal,GC,zmin,zmax)
...
if rscale =='linear':
    ...
    covfits = '{}catalog/nersc_mps_{}_{}/2PCF_{}_{}_{}_mocks_{}.fits.gz'.format(direc,gal,ver,function,rscale,gal,multipole)  
    
    obs2pcf  = '{}catalog/nersc_mps_{}_{}/2PCF_{}_{}_{}_{}.dat'.format(direc,gal,ver,function,rscale,gal,GC)
