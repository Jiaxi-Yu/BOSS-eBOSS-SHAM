...
if sys.argv[1] == 'LOWZ':
  fileroot = '/home/jiaxi/Desktop/BOSS_clustering/nbar_DR12v5_LOWZ_{}_om0p31_Pfkp10000.dat'
  zmins = [0.15,0.2, 0.33,0.2]
  zmaxs = [0.2, 0.33,0.43,0.43]
  z, nz,nzN,nzS = combineNS(fileroot,sample = ['North','South'])

elif sys.argv[1] == 'CMASS': 
  fileroot = '/home/jiaxi/Desktop/BOSS_clustering/nbar_DR12v5_CMASS_{}_om0p31_Pfkp10000.dat'
