...
# write the multinest/gedist analysis report
    ...
    if os.path.exists('{}best-fit_{}_{}-python.dat'.format(fileroot[:-10],gal,GC)):
        ...
        def sham_tpcf(*par):
            if date == '0729':
                x00,x20,v0,n0,wp0= sham_cal(par[0],par[2],par[3])
                x01,x21,v1,n1,wp1= sham_cal(par[1],par[2],par[3])
            else:
                x00,x20,v0,n0,wp0= sham_cal(par[0],par[2],par[3],par[4])
                x01,x21,v1,n1,wp1= sham_cal(par[1],par[2],par[3],par[4])
